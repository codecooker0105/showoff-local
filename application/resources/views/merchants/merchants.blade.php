    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-subheader ">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="m-subheader__title ">Merchants</h3>
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link">
                                <span class="m-nav__link-text">Merchants</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                <div class="m-portlet__body">
                    ...
                    <div id="refresh">
                        @include('merchants.render_merchants')
                    </div>
...
@endif
    ...
    <script type="text/javascript">
        ...
        function merchantstatusFunction(id) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{URL::to('admin/merchants/change-status')}}",
                        method: "POST",
                    ...
                    Swal.fire(
                        'Changed!',
                        'Merchants Status has been changed.',
                        'success'
                    )
                }
            })
        ...
        function archiveFunction(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    console.log(id);
                    $.ajax({
                        url: "{{URL::to('admin/merchants/delete/')}}",
                        method: "POST",
                        data: {'id': id, _token: '{{csrf_token()}}', 'page': '{{app('request')->page}}'},
                        dataType: "json",
                        success: function (data) {
