...
@section('content')
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            <!--begin::Portlet-->
            <form class="m-portlet" method="POST" action="{{url('/admin/ads/store')}}" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    {{--<div class="form-group m-form__group row" {{$errors->has('title') ? 'has-error' : ''}}>--}}
                                        ...
                                        {{--<div class="col-xl-9 col-lg-9">--}}
                                            {{--<input type="text" name="title" value="{{old('title')}}" class="form-control m-input" placeholder="">--}}
                                    ...
                                    <div class="form-group m-form__group row" {{$errors->has('company_name') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="company_name" value="{{old('company_name')}}" class="form-control m-input" placeholder="">
                                    ...
                                    <div class="form-group m-form__group row" {{$errors->has('start_time' ? 'has-error' : '')}}>
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">Start Time: </label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="start_time" value="{{old('start_time')}}" class="form-control plx_dateTimePicker m-input" placeholder="" autocomplete="off">
                                    ...
                                    <div class="form-group m-form__group row" {{$errors->has('end_time') ? 'has-error' : ''}}>
                                        <label class="col-xl-3 col-lg-3 col-form-label text-right">End Time: </label>
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="text" name="end_time" value="{{old('end_time')}}" class="form-control plx_dateTimePicker m-input" placeholder="" autocomplete="off">
                                    ...
                                    <div class="form-group m-form__group row" {{$errors->has('link') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <input type="url" name="link" value="{{old('link')}}" class="form-control m-input" placeholder="" autocomplete="off">
                                    ...
                                    <div class="form-group m-form__group row" {{$errors->has('description') ? 'has-error' : ''}}>
                                        ...
                                        <div class="col-xl-9 col-lg-9">
                                            <textarea name="description" id="" maxlength="500" placeholder="Maximum 500 Characters" rows="3" class="form-control">{{old('description')}}</textarea>
                                    ...
                                    {{--<div class="col-xl-9 col-lg-9">--}}
                                    {{--<input type="text" name="location" value="{{old('location')}}" class="form-control m-input" placeholder="">--}}
